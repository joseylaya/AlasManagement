@php
    // Query within the partial so a Livewire navigation always receives the
    // latest active gallery images instead of a stale parent-view collection.
    $carouselBanners = \App\Models\DashboardBanner::query()
...
@if($carouselBanners->isNotEmpty())
    ...
    >
        <div class="relative aspect-[16/7] min-h-[160px] bg-white sm:min-h-[210px]">
