        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    @error('product_name') <span class="text-xs text-rose-500 font-semibold mt-1 block">{{ $message }}</span> @error('product_name')
                </div>
                ...
                <div>
                    ...
                    @error('sku') <span class="text-xs text-rose-500 font-semibold mt-1 block">{{ $message }}</span> @error('sku')
                </div>
            </div>
